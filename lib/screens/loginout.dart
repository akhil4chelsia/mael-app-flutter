...
import 'package:mael/screens/login.dart';
import 'package:mael/screens/signup.dart';

class LoginOut extends StatelessWidget {
  static const String id = 'login_out';
  const LoginOut({
    Key? key,
  }) : super(key: key);
  @override
